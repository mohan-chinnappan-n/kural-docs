...
import chartJs2Gantt from '@salesforce/resourceUrl/chartJs2Gantt';


const BAR_HEIGHT = 4;

export default class ChartJsGantt extends LightningElement {
  ...
  renderedCallback() {
    ...
    loadScript(this, chartJs2Gantt + '/moment.js')
      .then(Promise.all([loadScript(this, chartJs2Gantt + '/Chart.min.js'), loadStyle(this, chartJs2Gantt + '/Chart.min.css')]))
      .then(() => loadScript(this, chartJs2Gantt + '/chartjs-plugin-subtitle.js'))
      .then(() => loadScript(this, chartJs2Gantt + '/chartjs-plugin-gantt.js'))
      .then(() => {
