...
import dhtmlxgantt713 from "@salesforce/resourceUrl/dhtmlxgantt713";
...
export default class Dhtmlxgc extends LightningElement {
    ...
    renderedCallback() {
        ...
        Promise.all([
            loadScript(this, dhtmlxgantt713 + '/dhtmlxgantt.js'),
            loadStyle(this, dhtmlxgantt713 + '/dhtmlxgantt.css'),
        ]).then(() => {
            this.initializeUI();
        }).catch(error => {
            this.dispatchEvent(
