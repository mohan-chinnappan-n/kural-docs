export class GanttUtil {
    ...
    // gu.date_utils.parse('2022-10-12')) ==>
    //    parsedDate Wed Oct 12 2022 00:00:00 GMT-0400 (Eastern Daylight Time)
    date_utils = {
    ...
    drawCircles = (chartClass, snap) => {

        const s = snap(chartClass);
    ...
    // gu.padStart('apple', 20, '$') ==> padStart $$$$$$$$$$$$$$$apple
